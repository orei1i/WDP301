...
import { DamageClaimModel, RentalContractModel, TicketModel, type UserHydrated } from '../db/models';
import { Forbidden, NotFound, Unprocessable } from '../core/errors';
import { assertCanAccess, assertFacility } from '../middlewares/scope';
import { CLAIM_LIABILITY_CAP, CLAIM_WINDOW_DAYS, claimTotal, MAX_OPEN_CLAIMS_PER_CONTRACT } from '../domain/claims';
