...
import { authenticate, verifyFirebase } from '../../shared/http/authenticate';
import type { RouteSchemas } from '../../shared/http/tags';
import { ROLES_TAG, SCHEMAS_TAG, readTag } from '../../shared/http/tags';
